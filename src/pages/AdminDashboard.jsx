...
const ProductManager = () => {
  ...
  const [adminMaxPrice, setAdminMaxPrice] = useState(100000);
  ...
  const filteredProducts = products?.filter(p =>
    ...
    p.discountedPrice <= adminMaxPrice
  ) || [];
  ...
  return (
    <div style={{ background: 'white', padding: '2.5rem', borderRadius: '45px', boxShadow: '0 30px 60px rgba(233,163,163,0.15)' }}>
      ...
      {/* Admin Price Filter */}
      <div style={{ marginBottom: '3rem', background: '#fffcfc', padding: '1.5rem', borderRadius: '25px', border: '1px solid #fff0f0' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
          <h4 style={{ fontSize: '0.8rem', fontWeight: 800, color: 'var(--primary)', textTransform: 'uppercase', letterSpacing: '1px' }}>Inventory Value Filter</h4>
          <span style={{ fontSize: '0.9rem', fontWeight: 800, color: 'var(--secondary)' }}>Up to ₹{parseInt(adminMaxPrice || 50000).toLocaleString()}</span>
        </div>
        <input 
          type="range" 
          min="0" 
          max="100000" 
          step="1000"
          value={adminMaxPrice || 50000}
          onChange={(e) => setAdminMaxPrice(e.target.value)}
          style={{ width: '100%', height: '6px', background: '#fff0f0', borderRadius: '10px', appearance: 'none', outline: 'none', cursor: 'pointer', accentColor: 'var(--primary)' }}
        />
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '2rem' }}>
        {filteredProducts.map(p => (
          <motion.div 
            ...
            style={{ background: '#fffcfc', borderRadius: '30px', border: '1px solid #fff0f0', overflow: 'hidden', transition: 'all 0.3s ease' }}
          >
  ...
  return (
    <div style={{ background: 'white', padding: '2.5rem', borderRadius: '45px', boxShadow: '0 30px 60px rgba(233,163,163,0.15)' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '3rem' }}>
        <div>
          <h3 style={{ fontSize: '1.8rem', fontFamily: 'Playfair Display', color: 'var(--secondary)', display: 'flex', alignItems: 'center', gap: '0.8rem' }}>Atelier Portfolio <Package size={22} color="var(--primary)" /></h3>
...
const CollectionsManager = () => {
  ...
  return (
    <div style={{ background: 'white', padding: '2.5rem', borderRadius: '45px', boxShadow: '0 30px 60px rgba(233,163,163,0.15)' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '3rem' }}>
        <div>
          <h3 style={{ fontSize: '1.8rem', fontFamily: 'Playfair Display', color: 'var(--secondary)', display: 'flex', alignItems: 'center', gap: '0.8rem' }}>Global Collections <Globe size={22} color="var(--primary)" /></h3>
          ...
          <motion.div key="overview" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -30 }}>
            ...
            <div style={{ display: 'flex', gap: '1.5rem', marginBottom: '3rem', flexWrap: 'wrap' }}>
              <button 
                ...
                style={{ flex: 1, minWidth: '200px', padding: '1.5rem', background: 'var(--primary)', color: 'white', border: 'none', borderRadius: '30px', fontWeight: 800, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1rem', boxShadow: '0 15px 30px rgba(233,163,163,0.3)' }}
              >
                <Plus size={24} /> Add New Product
              </button>
              <button 
                onClick={() => setActiveTab('catalog')} 
                style={{ flex: 1, minWidth: '200px', padding: '1.5rem', background: 'var(--secondary)', color: 'white', border: 'none', borderRadius: '30px', fontWeight: 800, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1rem', boxShadow: '0 15px 30px rgba(0,0,0,0.1)' }}
              >
                <Plus size={24} /> New Gallery Piece
              </button>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '3rem', marginBottom: '4rem' }}>
              ...
              <div style={{ background: 'white', padding: '2.5rem', borderRadius: '40px', boxShadow: '0 20px 40px rgba(233,163,163,0.1)', border: '1px solid #fff0f0' }}>
                <h3 style={{ marginBottom: '2.5rem', fontFamily: 'Playfair Display', fontSize: '1.6rem', color: 'var(--secondary)', display: 'flex', alignItems: 'center', gap: '0.8rem' }}>Needs Love <Cloud size={20} color="var(--primary)" /></h3>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div style={{ background: 'white', padding: 'clamp(1.5rem, 5vw, 3rem)', borderRadius: '40px', boxShadow: '0 20px 40px rgba(233,163,163,0.1)', border: '1px solid #fff0f0' }}>
              <h3 style={{ marginBottom: '2.5rem', fontFamily: 'Playfair Display', fontSize: '1.8rem', color: 'var(--secondary)', display: 'flex', alignItems: 'center', gap: '0.8rem' }}>Upcoming Tea & Designs <Coffee size={24} color="var(--primary)" /></h3>
